...
let camera3D, scene, renderer, cube, cube2;
...
function init3D() {
    ...
    const material = new THREE.MeshBasicMaterial({
        map: THREE.ImageUtils.loadTexture('paint.jpg')
     });
    ...
    const material2 = new THREE.MeshBasicMaterial({
        map: THREE.ImageUtils.loadTexture('brick.jpg')
     });
    ...
    let panotexture = new THREE.TextureLoader().load("back.jpg");
